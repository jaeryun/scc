...
| ---------------------------------- | ---------------- | -------------------- | ----------------------------------------------- |
| `components/charts/area-graph.tsx` | modules/demo/dashboard | `components/charts/` | 순수 recharts 래퍼, dashboard 삭제해도 의미 있음 |

| `components/charts/bar-graph.tsx`  | modules/demo/dashboard | `components/charts/` | recharts BarChart, 도메인 무관 재사용 가능      |

| `components/charts/pie-graph.tsx`  | modules/demo/dashboard | `components/charts/` | recharts PieChart, 범용 시각화                  |
