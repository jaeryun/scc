...
<!-- 이 파일은 form-patterns.md에서 분할됨. 2026-06-14.
     폼 시스템의 설정/구조/타입/익스포트 관련 패턴을 다룹니다.
     인덱스: [form-patterns.md](form-patterns.md) -->

[TanStack Form](https://tanstack.com/form) + shadcn/ui 기반의 폼 처리 시스템 설정 가이드입니다. 폼 아키텍처, 파일 분리, 사용 패턴(3가지), 사용 가능한 필드, 새 필드 추가 절차, 타입 안전성/익스포트 참조를 다룹니다.
