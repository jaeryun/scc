...
import { getSubnets, getSubnetById, getIpAddresses, searchIpByHostname } from './service';
...
export const ipAddressKeys = {
  ...
  lists: (filters: IpAddressFilters) => [...ipAddressKeys.all, 'list', filters] as const,
  search: (filters: HostnameSearchFilters) => [...ipAddressKeys.all, 'search', filters] as const
};
